...
4) Создать запись в media и в таблице соответствующего типа
5) Cохранить информацию о media в media_source_files и media_source_file_urls
6) Сохранить оригинал в одно из хранилищ storage и сделать записи в media_storage_objects и media_storage_locations
7) 